...
## 4. Regle absolue : une version publiee n'est jamais remplacee silencieusement
...
## 6. Rollback vers une version anterieure
...
## 7. Remplacer un artefact corrompu
